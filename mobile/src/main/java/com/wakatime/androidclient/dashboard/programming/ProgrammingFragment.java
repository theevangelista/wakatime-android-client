 ...
 * Use the {@link ProgrammingFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ProgrammingFragment extends Fragment implements ViewModel {
    ...
    @Inject
    ProgrammingPresenter mProgrammingPresenter;

    private DataObject rotationCache;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.mProgrammingPresenter.bind(this);
        return view;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null || !savedInstanceState.containsKey(LIST_STATE)) {
            this.mProgrammingPresenter.onInit();
        }
    ...
    @Override
    public void setRotationCache(DataObject data) {
        this.rotationCache = data;
    }

    private void setLanguageData(DataObject data) {
    ...
    private void setOSChart(DataObject data) {
    ...
    private void setEditorData(DataObject data) {
